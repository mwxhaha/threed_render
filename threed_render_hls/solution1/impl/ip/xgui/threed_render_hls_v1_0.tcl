...
proc update_MODELPARAM_VALUE.C_S_AXI_THREED_RENDER_HLS_IO_ADDR_WIDTH { MODELPARAM_VALUE.C_S_AXI_THREED_RENDER_HLS_IO_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "C_S_AXI_THREED_RENDER_HLS_IO_ADDR_WIDTH". Setting updated value from the model parameter.
set_property value 7 ${MODELPARAM_VALUE.C_S_AXI_THREED_RENDER_HLS_IO_ADDR_WIDTH}
}
