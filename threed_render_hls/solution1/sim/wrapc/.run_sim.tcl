...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/User/app/Xilinx/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/User/app/Xilinx/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/User/app/Xilinx/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/User/app/Xilinx/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "threed_render_hls.autotvin.dat"
	set constFileTvOut       "threed_render_hls.autotvout.dat"
	set constFileHdlTvIn     "threed_render_hls.autohdltvin.dat"
	set constFileHdlTvOut    "threed_render_hls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
