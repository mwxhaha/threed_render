...
if {[file isfile threed_render_hls.autotvin.dat]} {
	file delete -force threed_render_hls.autotvin.dat
}

if {[file isfile threed_render_hls.autotvout.dat]} {
	file delete -force threed_render_hls.autotvout.dat
}
