...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.threed_render_hls.autotvin_gmem.dat"
         "c.threed_render_hls.autotvin_mesh_transmission.dat"
         "c.threed_render_hls.autotvin_triangle_number.dat"
         "c.threed_render_hls.autotvin_screen_transmission.dat"
         "c.threed_render_hls.autotvin_screen_height.dat"
         "c.threed_render_hls.autotvin_screen_width.dat"
         "c.threed_render_hls.autotvin_rotation_x_theta.dat"
         "c.threed_render_hls.autotvin_rotation_y_theta.dat"
         "c.threed_render_hls.autotvin_rotation_z_theta.dat"
         "c.threed_render_hls.autotvin_distance_transmission.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.threed_render_hls.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
