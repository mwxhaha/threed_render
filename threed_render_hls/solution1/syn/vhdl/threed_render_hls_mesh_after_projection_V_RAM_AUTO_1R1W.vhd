...
entity threed_render_hls_mesh_after_projection_V_RAM_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 40; 
        AddressWidth    : integer   := 10;
        AddressRange    : integer   := 990
    ); 
    port (
...
architecture rtl of threed_render_hls_mesh_after_projection_V_RAM_AUTO_1R1W is 
