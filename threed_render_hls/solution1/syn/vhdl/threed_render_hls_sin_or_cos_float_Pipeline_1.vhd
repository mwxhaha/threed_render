...
entity threed_render_hls_sin_or_cos_float_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of threed_render_hls_sin_or_cos_float_Pipeline_1 is 
...
begin
    ...
    add_ln311_fu_92_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_6) + unsigned(ap_const_lv2_1));
    ...
    ap_sig_allocacmp_i_6_assign_proc : process(ap_CS_fsm_state1, i_fu_40, ap_loop_init)
    begin
    ...
    c_1_6_fu_142_p3 <= 
        ...
        c_1_fu_44;
    icmp_ln311_fu_86_p2 <= "1" when (ap_sig_allocacmp_i_6 = ap_const_lv2_2) else "0";
    ...
    p_Val2_s_fu_108_p3 <= 
        p_Result_88 when (trunc_ln553_fu_104_p1(0) = '1') else 
        p_Result_87;
    trunc_ln553_fu_104_p1 <= ap_sig_allocacmp_i_6(1 - 1 downto 0);
end behav;
