...
module threed_render_hls_sin_or_cos_float_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [31:0] p_Result_88;
input  [31:0] p_Result_87;
...
assign add_ln311_fu_92_p2 = (ap_sig_allocacmp_i_6 + 2'd1);
...
assign icmp_ln311_fu_86_p2 = ((ap_sig_allocacmp_i_6 == 2'd2) ? 1'b1 : 1'b0);
...
assign p_Val2_s_fu_108_p3 = ((trunc_ln553_fu_104_p1[0:0] == 1'b1) ? p_Result_88 : p_Result_87);

assign trunc_ln553_fu_104_p1 = ap_sig_allocacmp_i_6[0:0];

endmodule //threed_render_hls_sin_or_cos_float_Pipeline_1
