...
// Command     : write_verilog -force -mode synth_stub -rename_top threed_render_hw_threed_render_hls_0_0 -prefix
//               threed_render_hw_threed_render_hls_0_0_ threed_render_hw_threed_render_hls_0_0_stub.v
...
module threed_render_hw_threed_render_hls_0_0(s_axi_control_AWADDR, 
  s_axi_control_AWVALID, s_axi_control_AWREADY, s_axi_control_WDATA, s_axi_control_WSTRB, 
  s_axi_control_WVALID, s_axi_control_WREADY, s_axi_control_BRESP, s_axi_control_BVALID, 
  s_axi_control_BREADY, s_axi_control_ARADDR, s_axi_control_ARVALID, 
  s_axi_control_ARREADY, s_axi_control_RDATA, s_axi_control_RRESP, s_axi_control_RVALID, 
  s_axi_control_RREADY, s_axi_threed_render_hls_io_AWADDR, 
  ...
  s_axi_threed_render_hls_io_RVALID, s_axi_threed_render_hls_io_RREADY, ap_clk, ap_rst_n, 
  interrupt, m_axi_gmem_AWID, m_axi_gmem_AWADDR, m_axi_gmem_AWLEN, m_axi_gmem_AWSIZE, 
...
/* synthesis syn_black_box black_box_pad_pin="s_axi_control_AWADDR[5:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_BRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_ARADDR[5:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_RVALID,s_axi_control_RREADY,s_axi_threed_render_hls_io_AWADDR[6:0],s_axi_threed_render_hls_io_AWVALID,s_axi_threed_render_hls_io_AWREADY,s_axi_threed_render_hls_io_WDATA[31:0],s_axi_threed_render_hls_io_WSTRB[3:0],s_axi_threed_render_hls_io_WVALID,s_axi_threed_render_hls_io_WREADY,s_axi_threed_render_hls_io_BRESP[1:0],s_axi_threed_render_hls_io_BVALID,s_axi_threed_render_hls_io_BREADY,s_axi_threed_render_hls_io_ARADDR[6:0],s_axi_threed_render_hls_io_ARVALID,s_axi_threed_render_hls_io_ARREADY,s_axi_threed_render_hls_io_RDATA[31:0],s_axi_threed_render_hls_io_RRESP[1:0],s_axi_threed_render_hls_io_RVALID,s_axi_threed_render_hls_io_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_gmem_AWID[0:0],m_axi_gmem_AWADDR[63:0],m_axi_gmem_AWLEN[7:0],m_axi_gmem_AWSIZE[2:0],m_axi_gmem_AWBURST[1:0],m_axi_gmem_AWLOCK[1:0],m_axi_gmem_AWREGION[3:0],m_axi_gmem_AWCACHE[3:0],m_axi_gmem_AWPROT[2:0],m_axi_gmem_AWQOS[3:0],m_axi_gmem_AWVALID,m_axi_gmem_AWREADY,m_axi_gmem_WID[0:0],m_axi_gmem_WDATA[31:0],m_axi_gmem_WSTRB[3:0],m_axi_gmem_WLAST,m_axi_gmem_WVALID,m_axi_gmem_WREADY,m_axi_gmem_BID[0:0],m_axi_gmem_BRESP[1:0],m_axi_gmem_BVALID,m_axi_gmem_BREADY,m_axi_gmem_ARID[0:0],m_axi_gmem_ARADDR[63:0],m_axi_gmem_ARLEN[7:0],m_axi_gmem_ARSIZE[2:0],m_axi_gmem_ARBURST[1:0],m_axi_gmem_ARLOCK[1:0],m_axi_gmem_ARREGION[3:0],m_axi_gmem_ARCACHE[3:0],m_axi_gmem_ARPROT[2:0],m_axi_gmem_ARQOS[3:0],m_axi_gmem_ARVALID,m_axi_gmem_ARREADY,m_axi_gmem_RID[0:0],m_axi_gmem_RDATA[31:0],m_axi_gmem_RRESP[1:0],m_axi_gmem_RLAST,m_axi_gmem_RVALID,m_axi_gmem_RREADY" */;
  ...
  input [6:0]s_axi_threed_render_hls_io_AWADDR;
  ...
  input [6:0]s_axi_threed_render_hls_io_ARADDR;
